...
const CARDS = [
  {
    ...
    description:
      'Upload a Google Sheets export, map trainers and studios once, hit Start, and watch a worker grind through every row against MuAPI seedance-v2.0-i2v with retries, pause/resume, and per-row results.',
    href: '/batch',
    accent: 'bg-[#d9ff00] text-black hover:bg-[#e5ff33]',
    badge: 'For the marketing team',
    icon: (
      ...
      <main className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="max-w-5xl w-full">
          ...
          <p className="text-center text-[11px] text-white/30 mt-8">
            Self-hosted for Ahoum-Dev. <a href="/batch" className="hover:text-white/60">/batch</a>{' '}·{' '}
